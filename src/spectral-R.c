...
SEXP hermitianTridiagEig_d(SEXP Rptrd, SEXP RptrdSub, SEXP Rptrw){
  ElHermitianTridiagEig_d( toMatrix_d(Rptrd), toMatrix_d(RptrdSub),
                           toMatrix_d(Rptrw) );
  return R_NilValue;
}

SEXP hermitianTridiagEig_z(SEXP Rptrd, SEXP RptrdSub, SEXP Rptrw){
...
( SEXP Rptrd, SEXP RptrdSub, SEXP Rptrw){
...
( SEXP Rptrd, SEXP RptrdSub, SEXP Rptrw, SEXP RptrZ){
...
SEXP hermitianEig_d(SEXP uplo, SEXP RptrA, SEXP Rptrw){
  ElHermitianEig_d( parseUpLo(uplo), toMatrix_d(RptrA), toMatrix_d(Rptrw));
  return R_NilValue;
}

SEXP hermitianEig_z(SEXP uplo, SEXP RptrA, SEXP Rptrw){
  ElHermitianEig_z( parseUpLo(uplo), toMatrix_z(RptrA), toMatrix_d(Rptrw));
  return R_NilValue;
}

SEXP hermitianEigDist_d(SEXP uplo, SEXP RptrA, SEXP Rptrw){
  ElHermitianEigDist_d( parseUpLo(uplo), toDistMatrix_d(RptrA), 
                        toDistMatrix_d(Rptrw));
  return R_NilValue;
}

SEXP hermitianEigDist_z(SEXP uplo, SEXP RptrA, SEXP Rptrw){
...
(SEXP uplo, SEXP RptrA, SEXP Rptrw, SEXP RptrZ){
...
SEXP singularValues_d( SEXP RptrA, SEXP Rptrs){
  ElSingularValues_d( toMatrix_d(RptrA), toMatrix_d(Rptrs) );
  return R_NilValue;
}

SEXP singularValues_z( SEXP RptrA, SEXP Rptrs){
  ElSingularValues_z( toMatrix_z(RptrA), toMatrix_d(Rptrs) );
  return R_NilValue;
}

SEXP singularValuesDist_d( SEXP RptrA, SEXP Rptrs){
  ElSingularValuesDist_d( toDistMatrix_d(RptrA), toDistMatrix_d(Rptrs) );
  return R_NilValue;
}

SEXP singularValuesDist_z( SEXP RptrA, SEXP Rptrs){
...
SEXP tSQRSVDDist_d( SEXP RptrA, SEXP RptrU, SEXP Rptrs, SEXP RptrV){
  ElTSQRSVD_d( toDistMatrix_d(RptrA), toDistMatrix_d(RptrU), toDistMatrix_d(Rptrs),
	   toDistMatrix_d(RptrV) );
  return R_NilValue;
}

SEXP tSQRSVDDist_z( SEXP RptrA, SEXP RptrU, SEXP Rptrs, SEXP RptrV){
  ElTSQRSVD_z( toDistMatrix_z(RptrA), toDistMatrix_z(RptrU), toDistMatrix_d(Rptrs),
...
/*
SEXP tSQRSVDDist_d( SEXP RptrA, SEXP RptrU, SEXP Rptrs, SEXP RptrV){
  ElTSQRSVDDist_d( toDistMatrix_d(RptrA), toDistMatrix_d(RptrU), 
               toDistMatrix_d(Rptrs), toDistMatrix_d(RptrV) );
  return R_NilValue;
}

SEXP tSQRSVDDist_z( SEXP RptrA, SEXP RptrU, SEXP Rptrs, SEXP RptrV){
  ElTSQRSVDDist_z( toDistMatrix_z(RptrA), toDistMatrix_z(RptrU), 
               toDistMatrix_d(Rptrs), toDistMatrix_z(RptrV) );
  return R_NilValue;
}
